...
TCHAR * __stdcall dx_GetResourceIDString( int ResourceID ) 
{
...
{
	return GetDefaultState( SizeX, SizeY, ColorBitDepth);
}
...
int  __stdcall dx_LoadPauseGraphFromMem( void *  MemImage, int  MemImageSize)
{
...
HRGN __stdcall dx_CreateRgnFromGraph( int Width , int Height , void * MaskData , int Pitch , int Byte ) 
{
...
int  __stdcall dx_NetWorkSend( int  NetHandle, void *  Buffer, int  Length)
{
...
int  __stdcall dx_NetWorkSendUDP( int  NetUDPHandle, IPDATA  SendIP, int  SendPort, void *  Buffer, int  Length)
{
	return NetWorkSendUDP( NetUDPHandle, SendIP, SendPort, Buffer, Length);
}
int  __stdcall dx_NetWorkSendUDP_IPv6( int  NetUDPHandle, IPDATA_IPv6  SendIP, int  SendPort, void *  Buffer, int  Length)
{
...
IMEINPUTDATA * __stdcall dx_GetIMEInputData( void )
{
...
int __stdcall dx_ChangeStreamFunction( STREAMDATASHREDTYPE2 * StreamThread ) 
{
...
{
	return KeyboradBufferProcess( );
}
int __stdcall dx_GetJoypadGUID( int PadIndex , GUID * GuidBuffer ) 
{
	return GetJoypadGUID( PadIndex , GuidBuffer  ) ;
}
...
{
	return StartJoypadVibration( InputType, Power, Time);
}
int  __stdcall dx_StopJoypadVibration( int  InputType)
{
	return StopJoypadVibration( InputType);
}
...
int __stdcall dx_BltBmpToGraph( COLORDATA * BmpColorData , HBITMAP RgbBmp , HBITMAP AlphaBmp , int CopyPointX , int CopyPointY , int GrHandle ) 
{
	return BltBmpToGraph( BmpColorData , RgbBmp , AlphaBmp , CopyPointX , CopyPointY , GrHandle  ) ;
}
int __stdcall dx_BltBmpToDivGraph( COLORDATA * BmpColorData , HBITMAP RgbBmp , HBITMAP AlphaBmp , int AllNum , int XNum , int YNum , int Width , int Height , int * GrHandle , int ReverseFlag ) 
{
	return BltBmpToDivGraph( BmpColorData , RgbBmp , AlphaBmp , AllNum , XNum , YNum , Width , Height , GrHandle , ReverseFlag  ) ;
}
int __stdcall dx_BltBmpOrGraphImageToGraph( COLORDATA * BmpColorData , HBITMAP RgbBmp , HBITMAP AlphaBmp , int BmpFlag , BASEIMAGE * RgbImage , BASEIMAGE * AlphaImage , int CopyPointX , int CopyPointY , int GrHandle ) 
{
	return BltBmpOrGraphImageToGraph( BmpColorData , RgbBmp , AlphaBmp , BmpFlag , RgbImage , AlphaImage , CopyPointX , CopyPointY , GrHandle  ) ;
}
int __stdcall dx_BltBmpOrGraphImageToGraph2( COLORDATA * BmpColorData , HBITMAP RgbBmp , HBITMAP AlphaBmp , int BmpFlag , BASEIMAGE * RgbImage , BASEIMAGE * AlphaImage , RECT * SrcRect , int DestX , int DestY , int GrHandle ) 
{
	return BltBmpOrGraphImageToGraph2( BmpColorData , RgbBmp , AlphaBmp , BmpFlag , RgbImage , AlphaImage , SrcRect , DestX , DestY , GrHandle  ) ;
}
int __stdcall dx_BltBmpOrGraphImageToDivGraph( COLORDATA * BmpColorData , HBITMAP RgbBmp , HBITMAP AlphaBmp , int BmpFlag , BASEIMAGE * RgbImage , BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int Width , int Height , int * GrHandle , int ReverseFlag ) 
{
	return BltBmpOrGraphImageToDivGraph( BmpColorData , RgbBmp , AlphaBmp , BmpFlag , RgbImage , AlphaImage , AllNum , XNum , YNum , Width , Height , GrHandle , ReverseFlag  ) ;
}
...
int  __stdcall dx_CreateGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, void *  AlphaFileImage, int  AlphaFileImageSize, int  TextureFlag, int  ReverseFlag)
{
	return CreateGraphFromMem( RGBFileImage, RGBFileImageSize, AlphaFileImage, AlphaFileImageSize, TextureFlag, ReverseFlag);
}
int  __stdcall dx_ReCreateGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  GrHandle, void *  AlphaFileImage, int  AlphaFileImageSize, int  TextureFlag, int  ReverseFlag)
{
...
int  __stdcall dx_CreateDivGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, int  TextureFlag, int  ReverseFlag, void *  AlphaFileImage, int  AlphaFileImageSize)
{
...
int  __stdcall dx_ReCreateDivGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, int  TextureFlag, int  ReverseFlag, void *  AlphaFileImage, int  AlphaFileImageSize)
{
...
int __stdcall dx_CreateGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , BITMAPINFO * AlphaBmpInfo , void * AlphaBmpImage , int TextureFlag , int ReverseFlag ) 
{
	return CreateGraphFromBmp( RGBBmpInfo , RGBBmpImage , AlphaBmpInfo , AlphaBmpImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int GrHandle , BITMAPINFO * AlphaBmpInfo , void * AlphaBmpImage , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateGraphFromBmp( RGBBmpInfo , RGBBmpImage , GrHandle , AlphaBmpInfo , AlphaBmpImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_CreateDivGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag , BITMAPINFO * AlphaBmpInfo , void * AlphaBmpImage ) 
{
...
int __stdcall dx_ReCreateDivGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag , BITMAPINFO * AlphaBmpInfo , void * AlphaBmpImage ) 
{
...
int __stdcall dx_CreateDXGraph( BASEIMAGE * RgbImage , BASEIMAGE * AlphaImage , int TextureFlag ) 
{
	return CreateDXGraph( RgbImage , AlphaImage , TextureFlag  ) ;
}
int __stdcall dx_CreateGraphFromGraphImage( BASEIMAGE * RGBImage , int TextureFlag , int ReverseFlag ) 
{
	return CreateGraphFromGraphImage( RGBImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_CreateGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int TextureFlag , int ReverseFlag ) 
{
	return CreateGraphFromGraphImage( RGBImage , AlphaImage , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateGraphFromGraphImage( BASEIMAGE * RGBImage , int GrHandle , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateGraphFromGraphImage( RGBImage , GrHandle , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int GrHandle , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateGraphFromGraphImage( RGBImage , AlphaImage , GrHandle , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_CreateDivGraphFromGraphImage( BASEIMAGE * RGBImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return CreateDivGraphFromGraphImage( RGBImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_CreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return CreateDivGraphFromGraphImage( RGBImage , AlphaImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateDivGraphFromGraphImage( BASEIMAGE * RGBImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateDivGraphFromGraphImage( RGBImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int __stdcall dx_ReCreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateDivGraphFromGraphImage( RGBImage , AlphaImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
int  __stdcall dx_CreateGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, void *  AlphaImage, int  GrHandle)
{
	return CreateGraph( Width, Height, Pitch, RGBImage, AlphaImage, GrHandle);
}
int  __stdcall dx_CreateDivGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, void *  AlphaImage)
{
	return CreateDivGraph( Width, Height, Pitch, RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf, AlphaImage);
}
int  __stdcall dx_ReCreateGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, int  GrHandle, void *  AlphaImage)
{
...
int __stdcall dx_CreateGraphFromBaseImage( BASEIMAGE * BaseImage ) 
{
	return CreateGraphFromBaseImage( BaseImage  ) ;
}
int __stdcall dx_CreateGraphFromRectBaseImage( BASEIMAGE * BaseImage , int x , int y , int SizeX , int SizeY ) 
{
	return CreateGraphFromRectBaseImage( BaseImage , x , y , SizeX , SizeY  ) ;
}
int __stdcall dx_ReCreateGraphFromBaseImage( BASEIMAGE * BaseImage , int GrHandle ) 
{
	return ReCreateGraphFromBaseImage( BaseImage , GrHandle  ) ;
}
int __stdcall dx_ReCreateGraphFromRectBaseImage( BASEIMAGE * BaseImage , int x , int y , int SizeX , int SizeY , int GrHandle ) 
{
...
int  __stdcall dx_ReloadDivGraph( const char *  FileName, int  AllNum, int  XNum, int  YNum, int  XSize, int  YSize, int *  HandleBuf, int  ReverseFlag)
{
...
int  __stdcall dx_ReloadReverseDivGraph( const char *  FileName, int  AllNum, int  XNum, int  YNum, int  XSize, int  YSize, int *  HandleBuf)
{
...
DWORD * __stdcall dx_GetFullColorImage( int GrHandle ) 
{
...
{
	return GraphLock( GrHandle , PitchBuf , DataPointBuf , ColorDataPP  ) ;
}
...
COLORDATA * __stdcall dx_GetTexColorData( int AlphaCh , int AlphaTest , int ColorBitDepth , int DrawValid ) 
{
	return GetTexColorData( AlphaCh , AlphaTest , ColorBitDepth , DrawValid  ) ;
}
COLORDATA * __stdcall dx_GetTexColorData_2( IMAGEFORMATDESC * Format ) 
{
	return GetTexColorData( Format  ) ;
}
COLORDATA * __stdcall dx_GetTexColorData_3( int FormatIndex ) 
{
...
int  __stdcall dx_DrawCircle( int  x, int  y, int  r, int  Color, int  FillFlag)
{
	return DrawCircle( x, y, r, Color, FillFlag);
}
int  __stdcall dx_DrawOval( int  x, int  y, int  rx, int  ry, int  Color, int  FillFlag)
{
	return DrawOval( x, y, rx, ry, Color, FillFlag);
}
...
int  __stdcall dx_DrawPixelSet( POINTDATA *  PointData, int  Num)
{
	return DrawPixelSet( PointData, Num);
}
int  __stdcall dx_DrawLineSet( LINEDATA *  LineData, int  Num)
{
...
int __stdcall dx_DrawChipMap( int Sx , int Sy , int XNum , int YNum , int * MapData , int ChipTypeNum , int MapDataPitch , int * ChipGrHandle , int TransFlag ) 
{
	return DrawChipMap( Sx , Sy , XNum , YNum , MapData , ChipTypeNum , MapDataPitch , ChipGrHandle , TransFlag  ) ;
}
int __stdcall dx_DrawChipMap_2( int MapWidth , int MapHeight , int * MapData , int ChipTypeNum , int * ChipGrHandle , int TransFlag , int MapDrawPointX , int MapDrawPointY , int MapDrawWidth , int MapDrawHeight , int ScreenX , int ScreenY ) 
{
...
int  __stdcall dx_DrawPolygon( VERTEX *  Vertex, int  PolygonNum, int  GrHandle, int  TransFlag, int  UVScaling)
{
	return DrawPolygon( Vertex, PolygonNum, GrHandle, TransFlag, UVScaling);
}
int  __stdcall dx_DrawPolygon2D( VERTEX2D *  Vertex, int  PolygonNum, int  GrHandle, int  TransFlag)
{
	return DrawPolygon2D( Vertex, PolygonNum, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygon3D( VERTEX3D *  Vertex, int  PolygonNum, int  GrHandle, int  TransFlag)
{
	return DrawPolygon3D( Vertex, PolygonNum, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygonIndexed2D( VERTEX2D *  Vertex, int  VertexNum, unsigned short *  Indices, int  PolygonNum, int  GrHandle, int  TransFlag)
{
	return DrawPolygonIndexed2D( Vertex, VertexNum, Indices, PolygonNum, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygonIndexed3D( VERTEX3D *  Vertex, int  VertexNum, unsigned short *  Indices, int  PolygonNum, int  GrHandle, int  TransFlag)
{
	return DrawPolygonIndexed3D( Vertex, VertexNum, Indices, PolygonNum, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygonIndexed3DBase( VERTEX_3D *  Vertex, int  VertexNum, unsigned short *  Indices, int  IndexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
	return DrawPolygonIndexed3DBase( Vertex, VertexNum, Indices, IndexNum, PrimitiveType, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygon3DBase( VERTEX_3D *  Vertex, int  VertexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
	return DrawPolygon3DBase( Vertex, VertexNum, PrimitiveType, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygon3D_2( VERTEX_3D *  Vertex, int  PolygonNum, int  GrHandle, int  TransFlag)
{
	return DrawPolygon3D( Vertex, PolygonNum, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPolygonBase( VERTEX *  Vertex, int  VertexNum, int  PrimitiveType, int  GrHandle, int  TransFlag, int  UVScaling)
{
	return DrawPolygonBase( Vertex, VertexNum, PrimitiveType, GrHandle, TransFlag, UVScaling);
}
int  __stdcall dx_DrawPrimitive2D( VERTEX2D *  Vertex, int  VertexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
	return DrawPrimitive2D( Vertex, VertexNum, PrimitiveType, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPrimitive3D( VERTEX3D *  Vertex, int  VertexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
	return DrawPrimitive3D( Vertex, VertexNum, PrimitiveType, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPrimitiveIndexed2D( VERTEX2D *  Vertex, int  VertexNum, unsigned short *  Indices, int  IndexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
	return DrawPrimitiveIndexed2D( Vertex, VertexNum, Indices, IndexNum, PrimitiveType, GrHandle, TransFlag);
}
int  __stdcall dx_DrawPrimitiveIndexed3D( VERTEX3D *  Vertex, int  VertexNum, unsigned short *  Indices, int  IndexNum, int  PrimitiveType, int  GrHandle, int  TransFlag)
{
...
int  __stdcall dx_SetTransformToWorld( MATRIX *  Matrix)
{
...
int  __stdcall dx_SetTransformToView( MATRIX *  Matrix)
{
...
int  __stdcall dx_SetTransformToProjection( MATRIX *  Matrix)
{
...
int  __stdcall dx_SetTransformToViewport( MATRIX *  Matrix)
{
...
int __stdcall dx_ClearDrawScreen( RECT * ClearRect ) 
{
	return ClearDrawScreen( ClearRect  ) ;
}
int __stdcall dx_ClearDrawScreenZBuffer( RECT * ClearRect ) 
{
...
{
	return GetDisplayModeNum( );
}
DISPLAYMODEDATA  __stdcall dx_GetDisplayMode( int  ModeIndex)
{
	return GetDisplayMode( ModeIndex);
}
COLORDATA * __stdcall dx_GetDispColorData( void )
{
...
{
	return SetDisplayRefreshRate( RefreshRate);
}
...
int  __stdcall dx_SetWindowDrawRect( RECT *  DrawRect)
{
...
int __stdcall dx_SetDDrawUseGuid( GUID * Guid ) 
{
	return SetDDrawUseGuid( Guid  ) ;
}
void * __stdcall dx_GetUseDDrawObj( void )
{
	return GetUseDDrawObj(  ) ;
}
GUID * __stdcall dx_GetDirectDrawDeviceGUID( int Number ) 
{
...
DX_DIRECT3DDEVICE9 *  __stdcall dx_GetUseDirect3DDevice9( void)
{
	return GetUseDirect3DDevice9( );
}
DX_DIRECT3DSURFACE9 *  __stdcall dx_GetUseDirect3D9BackBufferSurface( void)
{
...
int  __stdcall dx_SetVertexBufferData( int  SetIndex, void *  VertexData, int  VertexNum, int  VertexBufHandle)
{
...
int  __stdcall dx_SetIndexBufferData( int  SetIndex, void *  IndexData, int  IndexNum, int  IndexBufHandle)
{
...
int  __stdcall dx_LoadVertexShaderFromMem( void *  ImageAddress, int  ImageSize)
{
	return LoadVertexShaderFromMem( ImageAddress, ImageSize);
}
int  __stdcall dx_LoadPixelShaderFromMem( void *  ImageAddress, int  ImageSize)
{
...
int  __stdcall dx_SetVSConstSFArray( int  ConstantIndex, float *  ParamArray, int  ParamNum)
{
	return SetVSConstSFArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstFArray( int  ConstantIndex, FLOAT4 *  ParamArray, int  ParamNum)
{
	return SetVSConstFArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstFMtxArray( int  ConstantIndex, MATRIX *  ParamArray, int  ParamNum)
{
	return SetVSConstFMtxArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstFMtxTArray( int  ConstantIndex, MATRIX *  ParamArray, int  ParamNum)
{
	return SetVSConstFMtxTArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstSIArray( int  ConstantIndex, int *  ParamArray, int  ParamNum)
{
	return SetVSConstSIArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstIArray( int  ConstantIndex, INT4 *  ParamArray, int  ParamNum)
{
	return SetVSConstIArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetVSConstBArray( int  ConstantIndex, BOOL *  ParamArray, int  ParamNum)
{
...
int  __stdcall dx_SetPSConstSFArray( int  ConstantIndex, float *  ParamArray, int  ParamNum)
{
	return SetPSConstSFArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstFArray( int  ConstantIndex, FLOAT4 *  ParamArray, int  ParamNum)
{
	return SetPSConstFArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstFMtxArray( int  ConstantIndex, MATRIX *  ParamArray, int  ParamNum)
{
	return SetPSConstFMtxArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstFMtxTArray( int  ConstantIndex, MATRIX *  ParamArray, int  ParamNum)
{
	return SetPSConstFMtxTArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstSIArray( int  ConstantIndex, int *  ParamArray, int  ParamNum)
{
	return SetPSConstSIArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstIArray( int  ConstantIndex, INT4 *  ParamArray, int  ParamNum)
{
	return SetPSConstIArray( ConstantIndex, ParamArray, ParamNum);
}
int  __stdcall dx_SetPSConstBArray( int  ConstantIndex, BOOL *  ParamArray, int  ParamNum)
{
...
int  __stdcall dx_CalcPolygonIndexedBinormalAndTangentsToShader( VERTEX3DSHADER *  Vertex, int  VertexNum, unsigned short *  Indices, int  PolygonNum)
{
	return CalcPolygonIndexedBinormalAndTangentsToShader( Vertex, VertexNum, Indices, PolygonNum);
}
int  __stdcall dx_DrawPolygon2DToShader( VERTEX2DSHADER *  Vertex, int  PolygonNum)
{
	return DrawPolygon2DToShader( Vertex, PolygonNum);
}
int  __stdcall dx_DrawPolygon3DToShader( VERTEX3DSHADER *  Vertex, int  PolygonNum)
{
	return DrawPolygon3DToShader( Vertex, PolygonNum);
}
int  __stdcall dx_DrawPolygonIndexed2DToShader( VERTEX2DSHADER *  Vertex, int  VertexNum, unsigned short *  Indices, int  PolygonNum)
{
	return DrawPolygonIndexed2DToShader( Vertex, VertexNum, Indices, PolygonNum);
}
int  __stdcall dx_DrawPolygonIndexed3DToShader( VERTEX3DSHADER *  Vertex, int  VertexNum, unsigned short *  Indices, int  PolygonNum)
{
	return DrawPolygonIndexed3DToShader( Vertex, VertexNum, Indices, PolygonNum);
}
int  __stdcall dx_DrawPrimitive2DToShader( VERTEX2DSHADER *  Vertex, int  VertexNum, int  PrimitiveType)
{
	return DrawPrimitive2DToShader( Vertex, VertexNum, PrimitiveType);
}
int  __stdcall dx_DrawPrimitive3DToShader( VERTEX3DSHADER *  Vertex, int  VertexNum, int  PrimitiveType)
{
	return DrawPrimitive3DToShader( Vertex, VertexNum, PrimitiveType);
}
int  __stdcall dx_DrawPrimitiveIndexed2DToShader( VERTEX2DSHADER *  Vertex, int  VertexNum, unsigned short *  Indices, int  IndexNum, int  PrimitiveType)
{
	return DrawPrimitiveIndexed2DToShader( Vertex, VertexNum, Indices, IndexNum, PrimitiveType);
}
int  __stdcall dx_DrawPrimitiveIndexed3DToShader( VERTEX3DSHADER *  Vertex, int  VertexNum, unsigned short *  Indices, int  IndexNum, int  PrimitiveType)
{
...
BASEIMAGE * __stdcall dx_GetMovieBaseImageToGraph( int GraphHandle , int * ImageUpdateFlag ) 
{
...
int  __stdcall dx_GetTexFormatIndex( IMAGEFORMATDESC *  Format)
{
	return GetTexFormatIndex( Format);
}
int  __stdcall dx_ColorKaiseki( void *  PixelData, COLORDATA *  ColorData)
{
...
{
	return CreatePixelFormat( PixelFormatBuf , ColorBitDepth , RedMask , GreenMask , BlueMask , AlphaMask  ) ;
}
...
int  __stdcall dx_DrawMaskToDirectData( int  x, int  y, int  Width, int  Height, void *  MaskData, int  TransMode)
{
	return DrawMaskToDirectData( x, y, Width, Height, MaskData, TransMode);
}
int  __stdcall dx_DrawFillMaskToDirectData( int  x1, int  y1, int  x2, int  y2, int  Width, int  Height, void *  MaskData)
{
...
int  __stdcall dx_SetDataToMask( int  Width, int  Height, void *  MaskData, int  MaskHandle)
{
...
int  __stdcall dx_EnumFontNameEx2( TCHAR *  NameBuffer, int  NameBufferNum, TCHAR *  EnumFontName, int  CharSet)
{
...
{
	return SetFontSpaceToHandle( Point, FontHandle);
}
...
int __stdcall dx_FontCacheStringDrawToHandle( int x , int y , const TCHAR * StrData , int Color , int EdgeColor , BASEIMAGE * DestImage , RECT * ClipRect , int FontHandle , int VerticalFlag , SIZE * DrawSizeP ) 
{
...
int  __stdcall dx_CreateLookAtMatrix( MATRIX *  Out, VECTOR *  Eye, VECTOR *  At, VECTOR *  Up)
{
	return CreateLookAtMatrix( Out, Eye, At, Up);
}
int  __stdcall dx_CreateLookAtMatrix2( MATRIX *  Out, VECTOR *  Eye, double  XZAngle, double  Oira)
{
	return CreateLookAtMatrix2( Out, Eye, XZAngle, Oira);
}
int  __stdcall dx_CreateLookAtMatrixRH( MATRIX *  Out, VECTOR *  Eye, VECTOR *  At, VECTOR *  Up)
{
	return CreateLookAtMatrixRH( Out, Eye, At, Up);
}
int  __stdcall dx_CreateMultiplyMatrix( MATRIX *  Out, MATRIX *  In1, MATRIX *  In2)
{
...
int  __stdcall dx_CreateTransposeMatrix( MATRIX *  Out, MATRIX *  In)
{
	return CreateTransposeMatrix( Out, In);
}
int  __stdcall dx_CreateInverseMatrix( MATRIX *  Out, MATRIX *  In)
{
...
int  __stdcall dx_GetMatrixXYZRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixXYZRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_GetMatrixXZYRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixXZYRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_GetMatrixYXZRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixYXZRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_GetMatrixYZXRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixYZXRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_GetMatrixZXYRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixZXYRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_GetMatrixZYXRotation( MATRIX *  In, float *  OutXRot, float *  OutYRot, float *  OutZRot)
{
	return GetMatrixZYXRotation( In, OutXRot, OutYRot, OutZRot);
}
int  __stdcall dx_VectorNormalize( VECTOR *  Out, VECTOR *  In)
{
	return VectorNormalize( Out, In);
}
int  __stdcall dx_VectorScale( VECTOR *  Out, VECTOR *  In, float  Scale)
{
	return VectorScale( Out, In, Scale);
}
int  __stdcall dx_VectorMultiply( VECTOR *  Out, VECTOR *  In1, VECTOR *  In2)
{
	return VectorMultiply( Out, In1, In2);
}
int  __stdcall dx_VectorSub( VECTOR *  Out, VECTOR *  In1, VECTOR *  In2)
{
	return VectorSub( Out, In1, In2);
}
int  __stdcall dx_VectorAdd( VECTOR *  Out, VECTOR *  In1, VECTOR *  In2)
{
	return VectorAdd( Out, In1, In2);
}
int  __stdcall dx_VectorOuterProduct( VECTOR *  Out, VECTOR *  In1, VECTOR *  In2)
{
	return VectorOuterProduct( Out, In1, In2);
}
float  __stdcall dx_VectorInnerProduct( VECTOR *  In1, VECTOR *  In2)
{
	return VectorInnerProduct( In1, In2);
}
int  __stdcall dx_VectorRotationX( VECTOR *  Out, VECTOR *  In, double  Angle)
{
	return VectorRotationX( Out, In, Angle);
}
int  __stdcall dx_VectorRotationY( VECTOR *  Out, VECTOR *  In, double  Angle)
{
	return VectorRotationY( Out, In, Angle);
}
int  __stdcall dx_VectorRotationZ( VECTOR *  Out, VECTOR *  In, double  Angle)
{
	return VectorRotationZ( Out, In, Angle);
}
int  __stdcall dx_VectorTransform( VECTOR *  Out, VECTOR *  InVec, MATRIX *  InMatrix)
{
	return VectorTransform( Out, InVec, InMatrix);
}
int  __stdcall dx_VectorTransform4( VECTOR *  Out, float *  V4Out, VECTOR *  InVec, float *  V4In, MATRIX *  InMatrix)
{
	return VectorTransform4( Out, V4Out, InVec, V4In, InMatrix);
}
void  __stdcall dx_TriangleBarycenter( VECTOR  TrianglePos1, VECTOR  TrianglePos2, VECTOR  TrianglePos3, VECTOR  Position, float *  u, float *  v, float *  w)
{
	TriangleBarycenter( TrianglePos1, TrianglePos2, TrianglePos3, Position, u, v, w);
}
...
int  __stdcall dx_RectClipping( RECT *  MotoRect, RECT *  ClippuRect)
{
	return RectClipping( MotoRect, ClippuRect);
}
int  __stdcall dx_RectAdjust( RECT *  Rect)
{
	return RectAdjust( Rect);
}
int  __stdcall dx_GetRectSize( RECT *  Rect, int *  Width, int *  Height)
{
...
int __stdcall dx_CreateGraphImageOrDIBGraph( const TCHAR * FileName , void * DataImage , int DataImageSize , int DataImageType , int BmpFlag , int ReverseFlag , BASEIMAGE * Image , BITMAPINFO * * BmpInfo , void * * GraphData ) 
{
	return CreateGraphImageOrDIBGraph( FileName , DataImage , DataImageSize , DataImageType , BmpFlag , ReverseFlag , Image , BmpInfo , GraphData  ) ;
}
int __stdcall dx_CreateGraphImageType2( STREAMDATA * Src , BASEIMAGE * Dest ) 
{
	return CreateGraphImageType2( Src , Dest  ) ;
}
int __stdcall dx_CreateBmpInfo( BITMAPINFO * BmpInfo , int Width , int Height , int Pitch , void * SrcGrData , void * * DestGrData ) 
{
	return CreateBmpInfo( BmpInfo , Width , Height , Pitch , SrcGrData , DestGrData  ) ;
}
DWORD __stdcall dx_GetGraphImageFullColorCode( BASEIMAGE * GraphImage , int x , int y ) 
{
	return GetGraphImageFullColorCode( GraphImage , x , y  ) ;
}
int __stdcall dx_CreateGraphImage_plus_Alpha( const TCHAR * FileName , void * RgbImage , int RgbImageSize , int RgbImageType , void * AlphaImage , int AlphaImageSize , int AlphaImageType , BASEIMAGE * RgbGraphImage , BASEIMAGE * AlphaGraphImage , int ReverseFlag ) 
{
...
HBITMAP __stdcall dx_CreateDIBGraphToMem( BITMAPINFO * BmpInfo , void * GraphData , int ReverseFlag , COLORDATA * SrcColor ) 
{
...
HBITMAP __stdcall dx_CreateDIBGraphVer2( const TCHAR * FileName , void * MemImage , int MemImageSize , int ImageType , int ReverseFlag , COLORDATA * SrcColor ) 
{
	return CreateDIBGraphVer2( FileName , MemImage , MemImageSize , ImageType , ReverseFlag , SrcColor  ) ;
}
int __stdcall dx_CreateDIBGraphVer2_plus_Alpha( const TCHAR * FileName , void * MemImage , int MemImageSize , void * AlphaImage , int AlphaImageSize , int ImageType , HBITMAP * RGBBmp , HBITMAP * AlphaBmp , int ReverseFlag , COLORDATA * SrcColor ) 
{
...
int __stdcall dx_ConvBitmapToGraphImage( BITMAPINFO * BmpInfo , void * GraphData , BASEIMAGE * GraphImage , int CopyFlag ) 
{
	return ConvBitmapToGraphImage( BmpInfo , GraphData , GraphImage , CopyFlag  ) ;
}
int __stdcall dx_ConvGraphImageToBitmap( BASEIMAGE * GraphImage , BITMAPINFO * BmpInfo , void * * GraphData , int CopyFlag , int FullColorConv ) 
{
...
int __stdcall dx_CreateBaseImage( const TCHAR * FileName , void * FileImage , int FileImageSize , int DataType , BASEIMAGE * BaseImage , int ReverseFlag ) 
{
	return CreateBaseImage( FileName , FileImage , FileImageSize , DataType , BaseImage , ReverseFlag  ) ;
}
int __stdcall dx_CreateGraphImage( const TCHAR * FileName , void * DataImage , int DataImageSize , int DataImageType , BASEIMAGE * GraphImage , int ReverseFlag ) 
{
...
int __stdcall dx_CreateBaseImageToMem( void * FileImage , int FileImageSize , BASEIMAGE * BaseImage , int ReverseFlag ) 
{
...
{
	return CreatePAL8ColorBaseImage( SizeX , SizeY , BaseImage  ) ;
}
int __stdcall dx_CreateColorDataBaseImage( int SizeX , int SizeY , COLORDATA * ColorData , BASEIMAGE * BaseImage ) 
{
	return CreateColorDataBaseImage( SizeX , SizeY , ColorData , BaseImage  ) ;
}
int __stdcall dx_GetBaseImageGraphDataSize( BASEIMAGE * BaseImage ) 
{
...
{
	return ConvertNormalFormatBaseImage( BaseImage  ) ;
}
...
int __stdcall dx_UpdateLayerdWindowForBaseImage( BASEIMAGE * BaseImage ) 
{
	return UpdateLayerdWindowForBaseImage( BaseImage  ) ;
}
int __stdcall dx_UpdateLayerdWindowForPremultipliedAlphaBaseImage( BASEIMAGE * BaseImage ) 
{
...
int __stdcall dx_GetPaletteBaseImage( BASEIMAGE * BaseImage , int PaletteNo , int * r , int * g , int * b , int * a ) 
{
...
int __stdcall dx_GetPixelPalCodeBaseImage( BASEIMAGE * BaseImage , int x , int y ) 
{
...
int __stdcall dx_CheckPixelAlphaBaseImage( BASEIMAGE * BaseImage ) 
{
	return CheckPixelAlphaBaseImage( BaseImage  ) ;
}
int __stdcall dx_SaveBaseImageToBmp( const TCHAR * FilePath , BASEIMAGE * BaseImage ) 
{
...
int  __stdcall dx_GetColor3( COLORDATA *  ColorData, int  Red, int  Green, int  Blue, int  Alpha)
{
	return GetColor3( ColorData, Red, Green, Blue, Alpha);
}
int  __stdcall dx_GetColor4( COLORDATA *  DestColorData, COLORDATA *  SrcColorData, int  SrcColor)
{
	return GetColor4( DestColorData, SrcColorData, SrcColor);
}
int  __stdcall dx_GetColor5( COLORDATA *  ColorData, int  Color, int *  Red, int *  Green, int *  Blue, int *  Alpha)
{
...
{
	return CreatePal8ColorData( ColorDataBuf);
}
...
int  __stdcall dx_CmpColorData( COLORDATA *  ColorData1, COLORDATA *  ColorData2)
{
...
int  __stdcall dx_LoadSoftImageToMem( void *  FileImage, int  FileImageSize)
{
...
{
	return MakePAL8ColorSoftImage( SizeX, SizeY);
}
...
int  __stdcall dx_AddStreamSoundMemToMem( void *  FileImage, int  FileImageSize, int  LoopNum, int  SoundHandle, int  StreamDataType, int  UnionHandle)
{
...
int  __stdcall dx_LoadSoundMemByMemImageBase( void *  FileImage, int  FileImageSize, int  BufferNum, int  UnionHandle)
{
	return LoadSoundMemByMemImageBase( FileImage, FileImageSize, BufferNum, UnionHandle);
}
int  __stdcall dx_LoadSoundMemByMemImage( void *  FileImage, int  FileImageSize, int  UnionHandle)
{
	return LoadSoundMemByMemImage( FileImage, FileImageSize, UnionHandle);
}
int __stdcall dx_LoadSoundMemByMemImage2( void * WaveImage , int WaveImageSize , WAVEFORMATEX * WaveFormat , int WaveHeaderSize ) 
{
	return LoadSoundMemByMemImage2( WaveImage , WaveImageSize , WaveFormat , WaveHeaderSize  ) ;
}
int  __stdcall dx_LoadSoundMemByMemImageToBufNumSitei( void *  FileImage, int  FileImageSize, int  BufferNum)
{
	return LoadSoundMemByMemImageToBufNumSitei( FileImage, FileImageSize, BufferNum);
}
int  __stdcall dx_LoadSoundMem2ByMemImage( void *  FileImage1, int  FileImageSize1, void *  FileImage2, int  FileImageSize2)
{
...
{
	return Set3DSoundListenerPosAndFrontPos( Position, FrontPosition, UpVector);
}
...
void *  __stdcall dx_GetDSoundObj( void)
{
	return GetDSoundObj( );
}
...
{
	return MakeSoftSoundCustom( ChannelNum, BitsPerSample, SamplesPerSec, SampleNum);
}
...
{
	return GetSoftSoundFormat( SoftSoundHandle, Channels, BitsPerSample, SamplesPerSec);
}
...
int  __stdcall dx_AddDirectDataSoftSoundPlayer( int  SSoundPlayerHandle, void *  SoundData, int  AddSampleNum)
{
...
int  __stdcall dx_LoadMusicMemByMemImage( void *  FileImage, int  FileImageSize)
{
...
int  __stdcall dx_PlayMusicByMemImage( void *  FileImage, int  FileImageSize, int  PlayType)
{
...
int __stdcall dx_MV1LoadModelFromMem( void * FileImage , int FileSize , int ( *FileReadFunc )( const TCHAR * FilePath , void * * FileImageAddr , int * FileSize , void * FileReadFuncData ) , int ( *FileReleaseFunc )( void * MemoryAddr , void * FileReadFuncData ) , void * FileReadFuncData ) 
{
