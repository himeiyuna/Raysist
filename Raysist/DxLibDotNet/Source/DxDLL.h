...
int  __stdcall dx_CreateGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, void *  AlphaFileImage = NULL, int  AlphaFileImageSize = 0, int  TextureFlag = TRUE, int  ReverseFlag = FALSE);
int  __stdcall dx_ReCreateGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  GrHandle, void *  AlphaFileImage = NULL, int  AlphaFileImageSize = 0, int  TextureFlag = TRUE, int  ReverseFlag = FALSE);
int  __stdcall dx_CreateDivGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, int  TextureFlag = TRUE, int  ReverseFlag = FALSE, void *  AlphaFileImage = NULL, int  AlphaFileImageSize = 0);
int  __stdcall dx_ReCreateDivGraphFromMem( void *  RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, int  TextureFlag = TRUE, int  ReverseFlag = FALSE, void *  AlphaFileImage = NULL, int  AlphaFileImageSize = 0);
int __stdcall dx_CreateGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , BITMAPINFO * AlphaBmpInfo = NULL , void * AlphaBmpImage = NULL , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_ReCreateGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int GrHandle , BITMAPINFO * AlphaBmpInfo = NULL , void * AlphaBmpImage = NULL , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_CreateDivGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE , BITMAPINFO * AlphaBmpInfo = NULL , void * AlphaBmpImage = NULL ) ;
int __stdcall dx_ReCreateDivGraphFromBmp( BITMAPINFO * RGBBmpInfo , void * RGBBmpImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE , BITMAPINFO * AlphaBmpInfo = NULL , void * AlphaBmpImage = NULL ) ;
int __stdcall dx_CreateDXGraph( BASEIMAGE * RgbImage , BASEIMAGE * AlphaImage , int TextureFlag ) ;
int __stdcall dx_CreateGraphFromGraphImage( BASEIMAGE * RGBImage , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_CreateGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_ReCreateGraphFromGraphImage( BASEIMAGE * RGBImage , int GrHandle , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_ReCreateGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int GrHandle , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
...
int __stdcall dx_CreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_ReCreateDivGraphFromGraphImage( BASEIMAGE * RGBImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int __stdcall dx_ReCreateDivGraphFromGraphImage_2( BASEIMAGE * RGBImage , BASEIMAGE * AlphaImage , int AllNum , int XNum , int YNum , int SizeX , int SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
int  __stdcall dx_CreateGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, void *  AlphaImage = NULL, int  GrHandle = -1);
int  __stdcall dx_CreateDivGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, int  AllNum, int  XNum, int  YNum, int  SizeX, int  SizeY, int *  HandleBuf, void *  AlphaImage = NULL);
int  __stdcall dx_ReCreateGraph( int  Width, int  Height, int  Pitch, void *  RGBImage, int  GrHandle, void *  AlphaImage = NULL);
...
int  __stdcall dx_ReloadDivGraph( const char *  FileName, int  AllNum, int  XNum, int  YNum, int  XSize, int  YSize, int *  HandleBuf, int  ReverseFlag = FALSE);
...
COLORDATA * __stdcall dx_GetTexColorData( int AlphaCh , int AlphaTest , int ColorBitDepth , int DrawValid = FALSE ) ;
...
int  __stdcall dx_DrawCircle( int  x, int  y, int  r, int  Color, int  FillFlag = TRUE);
...
int  __stdcall dx_DrawPolygon( VERTEX *  Vertex, int  PolygonNum, int  GrHandle, int  TransFlag, int  UVScaling = FALSE);
...
int  __stdcall dx_DrawPolygonBase( VERTEX *  Vertex, int  VertexNum, int  PrimitiveType, int  GrHandle, int  TransFlag, int  UVScaling = FALSE);
...
int __stdcall dx_ClearDrawScreen( RECT * ClearRect = NULL ) ;
int __stdcall dx_ClearDrawScreenZBuffer( RECT * ClearRect = NULL ) ;
...
BASEIMAGE * __stdcall dx_GetMovieBaseImageToGraph( int GraphHandle , int * ImageUpdateFlag = NULL ) ;
...
int  __stdcall dx_EnumFontNameEx2( TCHAR *  NameBuffer, int  NameBufferNum, TCHAR *  EnumFontName, int  CharSet = -1);
...
int __stdcall dx_FontCacheStringDrawToHandle( int x , int y , const TCHAR * StrData , int Color , int EdgeColor , BASEIMAGE * DestImage , RECT * ClipRect , int FontHandle , int VerticalFlag = FALSE , SIZE * DrawSizeP = NULL ) ;
...
int __stdcall dx_ConvGraphImageToBitmap( BASEIMAGE * GraphImage , BITMAPINFO * BmpInfo , void * * GraphData , int CopyFlag , int FullColorConv = TRUE ) ;
...
int __stdcall dx_CreateBaseImageToMem( void * FileImage , int FileImageSize , BASEIMAGE * BaseImage , int ReverseFlag = FALSE ) ;
...
int  __stdcall dx_GetColor3( COLORDATA *  ColorData, int  Red, int  Green, int  Blue, int  Alpha = 255);
...
int  __stdcall dx_AddStreamSoundMemToMem( void *  FileImage, int  FileImageSize, int  LoopNum, int  SoundHandle, int  StreamDataType, int  UnionHandle = -1);
...
int  __stdcall dx_LoadSoundMemByMemImageBase( void *  FileImage, int  FileImageSize, int  BufferNum, int  UnionHandle = -1);
int  __stdcall dx_LoadSoundMemByMemImage( void *  FileImage, int  FileImageSize, int  UnionHandle = -1);
...
int __stdcall dx_MV1LoadModelFromMem( void * FileImage , int FileSize , int ( *FileReadFunc )( const TCHAR * FilePath , void * * FileImageAddr , int * FileSize , void * FileReadFuncData ) , int ( *FileReleaseFunc )( void * MemoryAddr , void * FileReadFuncData ) , void * FileReadFuncData = NULL ) ;
