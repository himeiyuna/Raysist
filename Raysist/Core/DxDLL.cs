...
namespace DxLibDLL
{
	public static class DX
	{
		...
		public const int DX_BLENDMODE_NUM = 23;
		...
		public const int DX_GRAPH_FILTER_INTERP_ALPHA = 10;
		public const int DX_GRAPH_FILTER_NUM = 11;
		...
		public struct IMAGEFORMATDESC
		{
			...
			[FieldOffset(6)] public byte  BaseFormat;
			[FieldOffset(7)] public byte  MipMapCount;
			[FieldOffset(8)] public byte  AlphaTestFlag;
			[FieldOffset(9)] public byte  FloatTypeFlag;
			[FieldOffset(10)] public byte  ColorBitDepth;
			[FieldOffset(11)] public byte  ChannelNum;
			[FieldOffset(12)] public byte  ChannelBitDepth;
			[FieldOffset(13)] public byte  BlendGraphFlag;
			[FieldOffset(14)] public byte  UsePaletteFlag;
			[FieldOffset(15)] public byte  MSSamples;
			[FieldOffset(16)] public byte  MSQuality;
		};
		...
		extern static int  dx_DrawCircleGauge_x86( int  CenterX, int  CenterY, double  Percent, int  GrHandle, double  StartPercent);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_DrawCircleGauge")]
		extern static int  dx_DrawCircleGauge_x64( int  CenterX, int  CenterY, double  Percent, int  GrHandle, double  StartPercent);
		...
		extern static int  dx_SetRenderTargetToShader_x86( int  TargetIndex, int  DrawScreen, int  SurfaceIndex);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_SetRenderTargetToShader")]
		extern static int  dx_SetRenderTargetToShader_x64( int  TargetIndex, int  DrawScreen, int  SurfaceIndex);
		...
		extern static int  dx_MV1SetupReferenceMesh_x86( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_MV1SetupReferenceMesh")]
		extern static int  dx_MV1SetupReferenceMesh_x64( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
		...
		extern static int  dx_MV1TerminateReferenceMesh_x86( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_MV1TerminateReferenceMesh")]
		extern static int  dx_MV1TerminateReferenceMesh_x64( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
		...
		extern static int  dx_MV1RefreshReferenceMesh_x86( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
		[DllImport("DxLib_x64.dll", EntryPoint="dx_MV1RefreshReferenceMesh")]
		extern static int  dx_MV1RefreshReferenceMesh_x64( int  MHandle, int  FrameIndex, int  IsTransform, int  IsPositionOnly);
